...
adb shell pm enable org.risingos.setupwizard/org.risingos.setupwizard.SetupWizardExitActivity || true
if [[ ! -z "$has_google_suw" ]]
then
    wait ${!}
...
sleep 1
adb shell am start org.risingos.setupwizard/org.risingos.setupwizard.SetupWizardExitActivity || true
if [[ ! -z "$has_google_suw" ]]
then
    wait ${!}
    sleep 1
